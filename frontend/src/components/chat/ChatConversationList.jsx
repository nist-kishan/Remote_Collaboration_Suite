      ...
      <div className="flex flex-col h-full bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700">
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Chats</h2>
            <div className="flex items-center gap-2">
              <CustomButton size="sm" className="flex items-center gap-2">
                <Plus className="w-4 h-4" />
                New Chat
              </CustomButton>
              <CustomButton size="sm" variant="outline" className="flex items-center gap-2">
                <Plus className="w-4 h-4" />
                Group
              </CustomButton>
            </div>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <CustomButton onClick={() => refetch()} size="sm">
              Retry
            </CustomButton>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center justify-center h-full text-gray-500 dark:text-gray-400">
            ...
            {!searchTerm && !isLoading && (
              <div className="flex gap-2">
                <CustomButton onClick={() => setShowNewChat(true)} size="sm">
                  Start New Chat
                </CustomButton>
                <CustomButton onClick={() => setShowCreateGroup(true)} size="sm" variant="outline">
                  Create Group
                </CustomButton>
              </div>
            )}
              ...
              {userSearchData?.data?.data?.users && (
                <div className="max-h-64 overflow-y-auto">
                  {userSearchData.data.data.users.map((searchUser) => (
                    ...
                    >
                      <UserProfileAvatar user={searchUser} size="md" />
                      <div>

...
import { useWhiteboardCanvas } from '../../hook/useWhiteboardCanvas';
import WhiteboardToolbar from './WhiteboardToolbar';
import WhiteboardMobileMenu from './WhiteboardMobileMenu';
...
const WhiteboardCanvas = ({ 
  ...
  const {
    ...
    handleSave,
    handleSendMessage,
  } = useWhiteboardCanvas({ whiteboard, onSave, socket });
